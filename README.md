...
The simple shell project is a collaboration between **Diana Mbeja ** and **Joshua Otwori**, Software Engineering students at **Holberton School**, with which we can emulate the operation of a shell, which contains some of its most basic characteristics, such as : Handle `PATH`, Handle command lines with `arguments`.
...
Do you need clone [this repository](https://github.com/mbejadiana/simple_shell):
```
	git clone https://github.com/mbejadiana/simple_shell
```
